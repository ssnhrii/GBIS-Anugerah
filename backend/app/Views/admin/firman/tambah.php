    ...
    <div class="admin-container">
        ...
        <div class="admin-header">
            <div class="admin-welcome">
                <h1>Tambah Firman</h1>
                <p>Buat renungan atau artikel rohani baru</p>
            </div>
        ...
        <div class="admin-section">
            <form action="<?= base_url('admin/firman/simpan') ?>" method="post" class="form-jemaat">
                <?= csrf_field() ?>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <select id="kategori" name="kategori">
                                <option value="Renungan Harian" <?= old('kategori', 'Renungan Harian') === 'Renungan Harian' ? 'selected' : '' ?>>Renungan Harian</option>
                                <option value="Renungan Minggu" <?= old('kategori') === 'Renungan Minggu' ? 'selected' : '' ?>>Renungan Minggu</option>
                                <option value="Artikel Rohani" <?= old('kategori') === 'Artikel Rohani' ? 'selected' : '' ?>>Artikel Rohani</option>
                                <option value="Kesaksian" <?= old('kategori') === 'Kesaksian' ? 'selected' : '' ?>>Kesaksian</option>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="isi_ayat" name="isi_ayat" rows="4" 
                                      placeholder="Tulis isi ayat Alkitab di sini"><?= old('isi_ayat') ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-section full-width">
                        ...
                        <div class="form-group">
                            <textarea id="isi_renungan" name="isi_renungan" rows="12" 
                                      required><?= old('isi_renungan') ?></textarea>
                        </div>
                    </div>
