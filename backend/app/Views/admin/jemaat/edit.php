    ...
    <div class="admin-container">
        ...
        <div class="admin-header">
            <div class="admin-welcome">
                <h1>Edit Jemaat</h1>
                <p>Perbarui data anggota jemaat</p>
            </div>
        ...
        <div class="admin-section">
            <form action="<?= base_url('admin/jemaat/update/' . $jemaat['id']) ?>" method="post" class="form-jemaat">
                <?= csrf_field() ?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <select id="kategori" name="kategori" required>
                                    ...
                                    <option value="Pemuda" <?= old('kategori', $jemaat['kategori']) === 'Pemuda' ? 'selected' : '' ?>>Pemuda</option>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nomor_telepon" name="nomor_telepon" 
                                   value="<?= old('nomor_telepon', $jemaat['nomor_telepon']) ?>" 
