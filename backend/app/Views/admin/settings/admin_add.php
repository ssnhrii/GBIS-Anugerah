            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="full_name" class="form-control <?= isset($validation) && $validation->hasError('full_name') ? 'is-invalid' : '' ?>" value="<?= old('full_name') ?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="confirm_password" class="form-control <?= isset($validation) && $validation->hasError('confirm_password') ? 'is-invalid' : '' ?>" required>
