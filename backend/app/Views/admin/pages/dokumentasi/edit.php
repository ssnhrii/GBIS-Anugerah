...
<?= $this->include('admin/layouts/navbar') ?>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    <h6 class="mb-4">Edit Dokumentasi</h6>
                    
                    <form action="<?= base_url('admin/index.php?page=dokumentasi-update&id=' . $dokumentasi['id']) ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Judul <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="judul" value="<?= old('judul', $dokumentasi['judul']) ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control" name="tanggal_kegiatan" value="<?= old('tanggal_kegiatan', $dokumentasi['tanggal_kegiatan']) ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="fotografer" value="<?= old('fotografer', $dokumentasi['fotografer']) ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="deskripsi" rows="3"><?= old('deskripsi', $dokumentasi['deskripsi']) ?></textarea>
                            </div>
                        </div>
