...
<?= $this->include('admin/layouts/navbar') ?>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    ...
                    <form action="<?= base_url('admin/index.php?action=jemaat-update&id=' . $jemaat['id']) ?>" method="post">
                        <?= csrf_field() ?>
                        
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Nama Lengkap <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama_lengkap" value="<?= old('nama_lengkap', $jemaat['nama_lengkap']) ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" name="kategori" required>
                                    ...
                                    <option value="Kaum Bapak" <?= old('kategori', $jemaat['kategori']) == 'Kaum Bapak' ? 'selected' : '' ?>>Kaum Bapak</option>
                                    <option value="Kaum Ibu" <?= old('kategori', $jemaat['kategori']) == 'Kaum Ibu' ? 'selected' : '' ?>>Kaum Ibu</option>
                                    <option value="Pemuda" <?= old('kategori', $jemaat['kategori']) == 'Pemuda' ? 'selected' : '' ?>>Pemuda/i</option>
                                    <option value="Anak-anak" <?= old('kategori', $jemaat['kategori']) == 'Anak-anak' ? 'selected' : '' ?>>Anak-anak</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="tempat_lahir" value="<?= old('tempat_lahir', $jemaat['tempat_lahir']) ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control" name="tanggal_lahir" value="<?= old('tanggal_lahir', $jemaat['tanggal_lahir']) ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="alamat" rows="3"><?= old('alamat', $jemaat['alamat']) ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="telepon" value="<?= old('telepon', $jemaat['telepon']) ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="pekerjaan" value="<?= old('pekerjaan', $jemaat['pekerjaan']) ?>">
                            </div>
                        </div>
