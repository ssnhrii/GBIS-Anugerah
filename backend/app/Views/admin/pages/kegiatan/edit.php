...
<?= $this->include('admin/layouts/navbar') ?>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    ...
                    <form action="<?= base_url('admin/index.php?action=kegiatan-update&id=' . $kegiatan['id']) ?>" method="post">
                        <?= csrf_field() ?>
                        
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Judul Kegiatan <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="judul_kegiatan" value="<?= old('judul_kegiatan', $kegiatan['judul_kegiatan']) ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control" name="tanggal_kegiatan" value="<?= old('tanggal_kegiatan', $kegiatan['tanggal_kegiatan']) ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="time" class="form-control" name="waktu_mulai" value="<?= old('waktu_mulai', $kegiatan['waktu_mulai']) ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="time" class="form-control" name="waktu_selesai" value="<?= old('waktu_selesai', $kegiatan['waktu_selesai']) ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="lokasi" value="<?= old('lokasi', $kegiatan['lokasi']) ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="pembicara" value="<?= old('pembicara', $kegiatan['pembicara']) ?>">
                            </div>
                        </div>
